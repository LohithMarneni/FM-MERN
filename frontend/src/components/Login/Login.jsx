...
function Login() {
  ...
  return (
    <div className="Login flex justify-center mt-16 h-2/3">
      <div className="bg-green-100 bg-opacity-10 backdrop-blur-sm p-8 rounded-lg shadow-lg w-full max-w-md font-mono font-bold text-center ">
        <h2 className='text-2xl mb-6 text-white hover:text-orange-400'>Login</h2>
        <form autoComplete="on" className="space-y-6" onSubmit={loginHandler}>
          ...
          <button type="submit"
           className="btn w-full bg-orange-200 text-green-900 py-2 rounded hover:bg-orange-600 hover:text-white"  disabled={loader}>
            Sign in 
          </button>
